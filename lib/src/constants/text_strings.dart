...
// -- Splash Screen Text
const String tAppName = "DysThoughts";
const String tAppTagLine = "Screen for SLD \nFree For Everyone";
...
// -- Welcome Screen Text
const String tWelcomeTitle = "Welcome to DysThoughts";
const String tWelcomeSubTitle = "The only app to screen for SLD at no cost!";
